...
function Plot2D({
  ...
  const interactionRef = import_react2.default.useRef({ mode: "idle", startXRange: [0, 1], startYRange: [0, 1], startSvgX: 0, startSvgY: 0, pinchStartDist: 0, pinchCenterWorld: null, pinchLastDist: 0 });
  const pointers = import_react2.default.useRef(/* @__PURE__ */ new Map());
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: wrapperRef, className, style: __spreadValues({ position: "relative", width, height, overscrollBehavior: "contain", touchAction: pannable || zoomable || pinchZoomable ? "none" : "auto" }, style), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: setOverlayEl, style: { position: "absolute", inset: 0, pointerEvents: "none", fontFamily: "system-ui, Segoe UI, Roboto, sans-serif", fontSize: 12, color: "#222" } })
  ] });
}
